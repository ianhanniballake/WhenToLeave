...
public class CalendarUrl extends GoogleUrl
{
	...
	{
		final CalendarUrl result = forCalendarMetafeed();
	...
	{
		final CalendarUrl result = forRoot();
	...
	public static CalendarUrl forEventFeed(final String userId,
			final String visibility, final String projection)
	{
		final CalendarUrl result = forRoot();
